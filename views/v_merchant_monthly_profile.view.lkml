# The name of this view in Looker is "V Merchant Monthly Profile"
view: v_merchant_monthly_profile {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: mv.v_merchant_monthly_profile ;;
  ...
  dimension: active_month_flag {
    type: number
    sql: ${TABLE}.active_month_flag ;;
  }
  ...
  dimension: transaction_margin_excl_ono {
    type: number
    sql: ${TABLE}.transaction_margin_excl_ono ;;
  }

  dimension: transaction_margin_incl_ono {
    type: number
    sql: ${TABLE}.transaction_margin_incl_ono ;;
  }
