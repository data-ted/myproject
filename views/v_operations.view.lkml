# The name of this view in Looker is "V Operations"
view: v_operations {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: mv.v_operations ;;
  ...
  dimension: delivery_to_transaction {
    type: number
    sql: ${TABLE}.delivery_to_transaction ;;
  }
  ...
  measure: total_delivery_to_transaction {
    type: sum
    sql: ${delivery_to_transaction} ;;
  }

  measure: average_delivery_to_transaction {
    type: average
    sql: ${delivery_to_transaction} ;;
  }
  ...
  dimension: light_touch_vetted_rate {
    type: number
    sql: ${TABLE}.light_touch_vetted_rate ;;
  }
  ...
  dimension: logistics_dispatch_rate {
    type: number
    sql: ${TABLE}.logistics_dispatch_rate ;;
  }
  ...
  dimension: logistics_morning_star {
    type: number
    sql: ${TABLE}.logistics_morning_star ;;
  }
  ...
  dimension: manually_vetted_rate {
    type: number
    sql: ${TABLE}.manually_vetted_rate ;;
  }
  ...
  dimension: paid_to_payout {
    type: number
    sql: ${TABLE}.paid_to_payout ;;
  }
  ...
  dimension: payment_to_ahv {
    type: number
    sql: ${TABLE}.payment_to_ahv ;;
  }

  dimension: payment_to_auto_ahv {
    type: number
    sql: ${TABLE}.payment_to_auto_ahv ;;
  }

  dimension: payment_to_auto_vetting_sec {
    type: number
    sql: ${TABLE}.payment_to_auto_vetting_sec ;;
  }

  dimension: payment_to_digital_fica {
    type: number
    sql: ${TABLE}.payment_to_digital_fica ;;
  }

  dimension: payment_to_fica {
    type: number
    sql: ${TABLE}.payment_to_fica ;;
  }

  dimension: payment_to_manual_ahv {
    type: number
    sql: ${TABLE}.payment_to_manual_ahv ;;
  }

  dimension: payment_to_manual_fica {
    type: number
    sql: ${TABLE}.payment_to_manual_fica ;;
  }

  dimension: payment_to_sale {
    type: number
    sql: ${TABLE}.payment_to_sale ;;
  }
  ...
  dimension: reader_delivery_time {
    type: number
    sql: ${TABLE}.reader_delivery_time ;;
  }
  ...
  dimension: sale_to_vetting {
    type: number
    sql: ${TABLE}.sale_to_vetting ;;
  }
  ...
  dimension: submit_to_ahv {
    type: number
    sql: ${TABLE}.submit_to_ahv ;;
  }

  dimension: submit_to_auto_ahv {
    type: number
    sql: ${TABLE}.submit_to_auto_ahv ;;
  }

  dimension: submit_to_manual_ahv {
    type: number
    sql: ${TABLE}.submit_to_manual_ahv ;;
  }
  ...
  dimension: transaction_to_payout {
    type: number
    sql: ${TABLE}.transaction_to_payout ;;
  }
