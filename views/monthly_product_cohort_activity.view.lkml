# The name of this view in Looker is "Monthly Product Cohort Activity"
view: monthly_product_cohort_activity {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: mv.monthly_product_cohort_activity ;;
