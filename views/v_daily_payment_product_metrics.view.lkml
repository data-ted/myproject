# The name of this view in Looker is "V Daily Payment Product Metrics"
view: v_daily_payment_product_metrics {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: mv.v_daily_payment_product_metrics ;;
