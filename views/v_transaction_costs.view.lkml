# The name of this view in Looker is "V Transaction Costs"
view: v_transaction_costs {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: mv.v_transaction_costs ;;
  ...
  dimension: diarize_me_cost {
    type: number
    sql: ${TABLE}.diarize_me_cost ;;
  }
  ...
  dimension: lightspeed_cost {
    type: number
    sql: ${TABLE}.lightspeed_cost ;;
  }

  dimension: loyverse_cost {
    type: number
    sql: ${TABLE}.loyverse_cost ;;
  }
